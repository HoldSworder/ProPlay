export class FontStyle {
  ...
  F1(): string {
    return `${this.color} 1px 1px 0px, ${this.color} 2px 2px 0px`
  }

  F2(): string {
    return `${this.color} 0px 0px 6px`
  }

  F3(): string {
    return `rgb(255, 255, 255) 0px 0px 10px, rgb(255, 255, 255) 0px 0px 20px, rgb(255, 255, 255) 0px 0px 30px, ${
      this.color
    } 0px 0px 40px, ${this.color} 0px 0px 70px, ${this.color} 0px 0px 80px, ${
      this.color
    } 0px 0px 100px, ${this.color} 0px 0px 150px`
  }

  F4(): string {
    return `${this.color} 0px 2px 3px`
  }

  F5(): string {
    return `${this.color} 3px 3px 6px`
  }
  ...
  F8(): string {
    return `currentcolor 0px 0px 1px, ${this.color} -1px -1px 1px, ${
      this.color
    } 0px -1px 1px, ${this.color} 1px -1px 1px, ${this.color} 1px 0px 1px, ${
      this.color
    } 1px 1px 1px, ${this.color} 0px 1px 1px, ${this.color} -1px 1px 1px, ${
      this.color
    } -1px 0px 1px`
  }
